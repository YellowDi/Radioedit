...

{
	...
	["Click to enable protect mode. Protected addons will not be disabled"] = "보호 모드를 사용하려면 클릭하세요. 보호된 애드온은 사용 중지될 수 없습니다.",
	["Close"] = "닫기",
	["Default"] = "기본값",
	["Dependencies"] = "의존 애드온",
	["Disable All"] = "모두 사용 안 함",
	["Disabled on reloadUI"] = "UI 재시작 시 사용 안 함",
	["Embeds"] = "내장 애드온",
	["Enable All"] = "모두 사용",
	["Enter the new name for [%s]:"] = "[%s]의 새로운 이름 입력:",
	["Load"] = "로드",
	["Loadable OnDemand"] = "요청 시 로드 가능",
	["Loaded"] = "불러들임",
	...
	["Reload"] = "재시작",
	["Reload your User Interface?"] = "사용자 인터페이스를 재시작할까요?",
	["ReloadUI"] = "UI 재시작",
	["Remove from current selection"] = "현재 선택된 것에서 삭제",
	["Rename"] = "이름바꾸기",
	["Resurse-ToolTip"] = "애드온을 사용할 때, 그 애드온이 의존하는 애드온 사용 시도",
	["Save"] = "저장하기",
