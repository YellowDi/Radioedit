...
function M:LoadExpRepBar()
	...
	E:CreateMover(self.expBar, "ExperienceBarMover", L["Experience Bar"], nil, nil, nil, 'ALL', function() return E.db.general.experience.enable; end)
	E:CreateMover(self.repBar, "ReputationBarMover", L["Reputation Bar"], nil, nil, nil, 'ALL', function() return E.db.general.reputation.enable; end)
end