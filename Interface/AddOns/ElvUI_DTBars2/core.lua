...
E.PopupDialogs["DT_Panel_Add"] = {
	...
	button1 = ACCEPT,
	button2 = CANCEL,
	OnAccept = function() local s = E.global.dtbarsSetup; DB:InsertPanel(s.name, s.slots, s.growth, s.width, s.transparent, s.pethide, s.anchor, s.point, s.x, s.y, s.strata, s.hide); ReloadUI() end,
	timeout = 0,
	whileDead = 1,
	hideOnEscape = false,
}
...
--Creating new panel
function DB:InsertPanel(name, slots, growth, width, transparent, pethide, anchor, point, x, y, strata, hide)
