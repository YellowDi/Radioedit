...
if FNP_LOCALE_TEXT.FNP_ENABLE_TXT == nil then
...
FNP_LOCALE_TEXT.FNP_TXT_BIG = "Big";
FNP_LOCALE_TEXT.FNP_TXT_SMALL = "Small";
...
FNP_LOCALE_TEXT.FNP_MENU_KILLLINE = "EXECUTION";
