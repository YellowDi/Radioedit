...
function GSTRTranslateSpell(str, fromLocale, toLocale, cleanNewLines)
  ...
  if string.match(str, ";") then
    ...
    if foundspell then
      ...
      if nfoundspell and GSAvailableLanguages[GSTRStaticKey][toLocale][nfoundspell] then
        GSPrintDebugMessage("Translating from the shadow table for  Spell ID : " .. nfoundspell .. " to " .. toLocale, GNOME)
