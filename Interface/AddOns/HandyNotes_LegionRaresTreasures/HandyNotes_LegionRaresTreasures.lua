...
nodes["Azsuna"] = {
	...
	[51502435]={ "42289", "藏寶箱", "增加神兵之力", "在山洞內; 入口座標：47.8,23.7", "default", "treasure_azs","138783"},
	...
	[53543982]={ "42285", "小型藏寶箱", "增加神兵之力", "神殿內有兩個寶藏", "default", "treasure_azs","138783"},
	...
	[43392242]={ "42297", "發光的藏寶箱", "增加神兵之力", "在山頂上; 從諾丹尼爾之泉右邊的小徑（坐標︰39.14,32.84）上山", "default", "treasure_azs", "138783"},
	...
	[43172813]={ "38352", "厄運領主卡茲洛克", "智力/致命一擊 飾品（智力職業掉落）", "跟製鞋匠泰德交談以觸發戰鬥", "skull_grey", "rare_azs", "129056"},
	...
	[65164000]={ "37820", "『鐵鰭』哥札", "敏捷/精通 飾品（敏捷職業掉落）", "點擊海妖之角並殺死納迦後出現", "skull_grey", "rare_azs","129091"},
	...
	[43572444]={ "42069", "魔翼蝙蝠", "致命一擊/精通 皮甲 手腕（皮甲職業掉落）", "在山頂上; 從諾丹尼爾之泉右邊的小徑（坐標︰39.14,32.84）上山", "skull_grey", "rare_azs","129087"},
}
...
nodes["Valsharah"] = {
	...
	[54003489]={ "38390", "發光的藏寶箱", "增加神兵之力", "在山洞內; 入口座標：53.2,38.0; 在寶箱附近會受到夢魘影響傳送到外面，需要以最快時間打開寶箱", "default", "treasure_val","141891"},
	...
	[67504510]={ "39130", "惡臭的波勞斯", "寵物", "", "skull_grey", "rare_val", "130168"},
}
...
nodes["Highmountain"] = {
	...
	[40975775]={ "39963", "火鱗", "致命一擊/精通 鎖甲 胸部（鎖甲職業掉落）", "點擊棄置的釣魚竿召喚它", "skull_grey", "rare_hmn","131773"},
	...
	[36741635]={ "40084", "『囤積者』波達許", "力量 飾品 （攻擊觸發精通）（力量職業掉落）", "", "skull_grey", "rare_hmn", "131799"},
	...
	[52305860]={ "40423", "沒品的冒險者", "根據職業掉落相應物品（布甲手/皮甲手/鎖甲手腕/鎧甲手腕）", "在山洞內; 點擊寶藏召喚", "skull_grey", "rare_hmn", "140680"},
 }
...
nodes["Stormheim"] = {
	...
	[47174983]={ "38774", "『失落者』提塔格", "力量 飾品(使用造成範圍傷害)（力量職業掉落）", "", "skull_grey", "rare_sth","129163"},
...
nodes["Suramar"] = {
	...
	[35561209]={ "43989", "秘法能量單位", "增加100點上古法力的上限", "", "default", "treasure_sur", "140329"},
	...
	[48297121]={ "44324", "藏寶箱", "增加神兵之力", "跳上門口左邊的書架，藏寶箱在上層，需要調整視覺拾取", "default", "treasure_sur", "138783"},
	...
	[26877073]={ "43987", "克托斯的研究報告", "增加100點上古法力的上限", "在山洞內; 入口座標：27.29,72.87", "default", "treasure_sur", "140327"},
	[76876150]={ "43860", "小型藏寶箱", "增加神兵之力", "在船內", "default", "treasure_sur", "138783"},
	[71464975]={ "43859", "小型藏寶箱", "增加神兵之力", "在塔頂", "default", "treasure_sur", "138783"},
	[52292990]={ "43854", "小型藏寶箱", "增加神兵之力", "在山洞內; 入口座標：49.5, 33.9", "default", "treasure_sur", "138783"},
	[81965745]={ "43861", "小型藏寶箱", "增加神兵之力", "入口座標：79.3, 57.4", "default", "treasure_sur", "138783"},
	[63654911]={ "43857", "小型藏寶箱", "增加神兵之力", "", "default", "treasure_sur", "138783"},
	[19791604]={ "43845", "小型藏寶箱", "增加神兵之力", "在山洞內; 入口座標：19.4, 19.4", "default", "treasure_sur", "138783"},
	[32277708]={ "43834", "藏寶箱", "增加神兵之力", "使用魔魂指揮所的燃燒軍團傳送門才能到達（坐標：31.0, 85.1; 需要毀壞滅光之地的任務才能使用傳送門）", "default", "treasure_sur", "138783"},
	...
	[54435612]={ "43792", "戴葛倫", "等級800 敏捷 飾品（攻擊觸發範圍傷害）（敏捷職業掉落）", "", "skull_grey", "rare_sur", "121808"},
	...
	[22135178]={ "41319", "精靈之禍", "等級800 精通 飾品 （攻擊觸發力量）（力量職業掉落）", "", "skull_grey", "rare_sur","121806"},
	...
	[62506369]={ "43793", "麥亞蘇", "等級800 加速 飾品（遠程攻擊觸發範圍傷害）（遠程職業掉落）", "", "skull_grey", "rare_sur", "121810"},
...
nodes["FalanaarTunnels"] = {
	[35513253]={ "43747", "閃爍的上古法力晶簇", "增加上古法力", "在法拉納爾隧道", "default", "treasure_sur", "139786"},
	[48644258]={ "43839", "小型藏寶箱", "增加神兵之力", "在法拉納爾隧道的蜘蛛網上", "default", "treasure_sur", "138783"},
	[23354815]={ "43840", "藏寶箱", "增加神兵之力", "在法拉納爾隧道", "default", "treasure_sur", "138783"},
	[35525280]={ "43988", "易變地脈水晶", "增加100點上古法力的上限", "在菲阿多拉神殿的下層; 暫時缺少questID", "default", "treasure_sur", "140328"},
	[38605414]={ "43838", "小型藏寶箱", "增加神兵之力", "在菲阿多拉神殿的下層", "default", "treasure_sur", "138783"},
}
