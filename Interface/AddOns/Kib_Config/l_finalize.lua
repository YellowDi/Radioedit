...
--<<IMPORTANT STUFF>>-------------------------------------------------------------------------------<<>>
    ...
    local ConfigDefaults = {LanguageID = 11, FontID = 1, UseAsGlobalFont = false, UseOldMenu = false, ShowConfigButton = true,}

    local FontList = {
    	{BlizFonts .. "ARKai_T.ttf", "zhCN:ARKai_T"},{BlizFonts .."ARKai_C.ttf", "zhCN: ARKai_C"}, {BlizFonts .. "ARHei.ttf", "zhCN: ARHei"},
        {BlizFonts .. "ARIALN.ttf", "zhCN: ARIALN"},{KibFonts .. "Walkway.ttf", "Walkway"}, {KibFonts .. "UrbanElegance.ttf", "Urban Elegance"}, 
        {KibFonts .. "Prototype.ttf", "Prototype"}, {KibFonts .. "Mobile_Sans.ttf", "Mobile Sans"}, {KibFonts .. "Cinzel.ttf", "Cinzel"},  
        {KibFonts .. "EarthOrbiter.ttf", "Earth Orbiter"}, {KibFonts .. "ModernSerif.ttf", "Modern Serif"}, {BlizFonts .."ARIALN.ttf", "Bliz: Arialn"}, 
        {BlizFonts .. "FRIZQT__.ttf", "Bliz: Friz Quadrata"}, {BlizFonts .. "MORPHEUS.ttf", "Bliz: Morpheus"}, {BlizFonts .. "skurri.ttf", "Bliz: Skurri"},
    }
