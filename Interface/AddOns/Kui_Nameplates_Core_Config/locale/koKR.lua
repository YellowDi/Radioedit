...
L["titles"] = {
	...
	["bossmod_enable"] = "우두머리 모듈 소통 모듈 활성화",
...
L["tooltips"] = {
 ...
 KuiSpellListConfig|r를 계속 사용할 수 있습니다.]=],
	...
	["bossmod_control_visibility"] = "우두머리 모듈은 이름표 애드온에 메시지를 전송하여 자동 전투 전환같은 설정을 무시하고 우두머리 전투 중 이름표 활성화를 유지하여 이름표에 추가 정보를 표시할 수 있습니다.|n|n|cffff6666이 옵션을 비활성하고 이름표를 활성화하지 않으면 우두머리 모듈은 당신에게 이 정보를 표시할 수 없습니다.",
	["bossmod_enable"] = "우두머리가 시전한 주요 강화 효과 또는 약화 효과같은 우두머리 전투와 관련된 추가 정보를 이름표에 표시하도록 우두머리 모듈 애드온은 이름표 애드온과 소통할 수 있습니다.",
