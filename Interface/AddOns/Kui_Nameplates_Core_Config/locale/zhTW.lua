...
L["titles"] = {
	...
	["auras_hide_all_other"] = "將他人施放的所有光環列入黑名單",
	...
	["bar_animation"] = "血條動畫",
	["bar_texture"] = "血條材質",
	["bossmod_clickthrough"] = "血條自動顯示時啟用點擊穿透",
	["bossmod_control_visibility"] = "允許首領警報插件控制友方血條的能見度",
...
L["tooltips"] = {
	...
	["bossmod_control_visibility"] = "首領警報插件可以發送訊息給血條插件，通知他們在首領戰中保持啟用友方的血條；並忽略其他設定（如自動戰鬥切換）以便在友方玩家顯示額外的訊息。|n|n|cffff6666如果禁用此選項、並且沒有啟用友方血條，首領警報模組將無法顯示資訊。",
	["bossmod_enable"] = "首領警報插件可以與血條插件交流，在相關首領戰中於血條上顯示額外訊息；例如首領施放的重要增減益效果。",
...
--Translation missing
	...
	["class_colour_enemy_names"] = "根據職業著色敵方玩家名字，同時也影響名字模式的文字文本。",
	["class_colour_friendly_names"] = "根據職業著色友方玩家名字，同時也影響名字模式的文字文本。",
	...
	["fade_alpha"] = "淡出框架的透明度。請注意：如果設為0（即框架不可見），則不可見的名條仍然可以點擊。 插件不能任意禁用名條的點擊框",
	...
	["nameonly_enemies"] = "在不可攻擊的敵方使用名字模式（不包括在免疫狀態下的敵方玩家）",
	["nameonly_health_colour"] = "以部份著色的方式來顯示血量百分比",
	["nameonly_in_combat"] = "在戰鬥中使用名字模式（將同時在敵方玩家身上啟用）|n|n注意，這不適用於訓練假人或其他沒有威脅值列表的單位。",
	...
	["tankmode_other_colour"] = "當其他坦克接力坦住時的血條顏色。|n|n只對坦克專精生效，並且需要其他坦克在你的團隊中、而且職責要設定為坦克。",
	["tankmode_tank_colour"] = "穩定坦住時的血條顏色",
	["tankmode_trans_colour"] = "獲得或失去仇恨時的血條顏色",
	["target_arrows"] = "在當前目標周圍顯示箭頭。箭頭的顏色繼承目標的光暈顏色。",
	["text_vertical_offset"] = "名條文字的全局垂直偏移量。針對WOW中某些比較奇怪的字體渲染作出微調。注意：尾數設為.5有助於在名條移動時減少抖動現象",
	["threat_brackets"] = "顯示威脅括弧",
	["title_text_players"] = "顯示玩家頭銜",
	["use_blizzard_personal"] = [=[不美化個人資源或是職業能量。|n|n當啟用此選項，個人框架可以在「框架尺寸」中的「個人資源」選項中調整，但是需要重載UI才能完全生效。|n|n要讓此框架顯示，你必須勾選在Esc > 介面 > 名稱 > 單位名條中的「顯示個人資源」選項。|n|n要顯示未被美化的職業資源，必須在同一頁面取消勾選「顯示目標的特殊資源」。|n|n|cffff6666如果當前框架可見，則需要重載UI。
]=],
}
