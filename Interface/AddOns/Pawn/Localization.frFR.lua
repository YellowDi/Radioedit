...
Pour plus d'information sur la Personnalisation de Pawn, regarder le fichier d'aide (Readme.htm) inclu dans le mod.]=],
	...
	["TooltipParsing"] = {
		["Agility"] = "^%+?([-%d%. ,]+) Agilité$",
		["AllStats"] = "^%+?([%d%. ,]+) à toutes les caractéristiques$",
		["Ap"] = "^%+?([%d%. ,]+) à la puissance d'attaque$",
		["Armor"] = "^Armure : ([%d%. ,]+)$",
		["Armor2"] = "^UNUSED$",
		["Avoidance"] = "^%+([%d%. ,]+) Évitement$",
		["Axe"] = "^Hache$",
		["BagSlots"] = "^Sac %d+ .+$",
		["Bow"] = "^Arc$",
		...
		["Dodge"] = "^%+?([%d%. ,]+) Esquive$",
		["Dodge2"] = "^%+?([%d%. ,]+) à l'esquive$",
		["Dps"] = "^%(([%d%. ,]+) dégâts par seconde%)$",
		["DpsAdd"] = "^Ajoute ([%d%. ,]+) dégâts par seconde$",
		["Duration"] = "^Durée :",
		["Elite"] = "^Elite$",
		["EnchantmentArmorKit"] = "^Renforcé %(%+(%d+) Armure%)$",
		["EnchantmentCounterweight"] = "^Contrepoids %(%+([%d%. ,]+) à la hâte%)",
		...
		["HeirloomXpBoost"] = "^Équipé : L?'?[Ee]xpérience gagnée",
		...
		["Hp52"] = "^Equipé: Reconstitue([%d%. ,]+) de vie par 5 sec%.$",
		...
		["Parry"] = "^%+?([%d%. ,]+) Parade$",
		["Parry2"] = "^%+?([%d%. ,]+) à la parade$",
		["Plate"] = "^Plaques$",
		["Polearm"] = "^Arme d'hast$",
		["PvPPower"] = "^%+?([%d%. ,]+) [Pp]uissance %(JcJ%)$",
		["RaidFinder"] = "^Outil Raids$",
		["Requires2"] = "^Niveau [%d%.,]+ requis$",
		["Resilience"] = "^%+?([%d%. ,]+) Résilience %(JcJ%)$",
		["Resilience2"] = "^%+?([%d%. ,]+) à la résilience %(JcJ%)$",
		["Scope"] = "^Lunette %(%+([%d%. ,]+) points de dégâts%)$",
		["ScopeCrit"] = "^Lunette %(%+([%d%. ,]+) au score de critique%)$",
		["ScopeRangedCrit"] = "^%+?([%d%. ,]+) au score de critique à distance$",
		["Shield"] = "^Bouclier$",
		...
		["WeaponDamage"] = "^Dégâts.?.?: ([%d%. ,]+) %- ([%d%. ,]+)$",
		["WeaponDamageArcane"] = "^%+?([%d%. ,]+) %- ([%d%. ,]+) points de dégâts %(Arcanes%)$",
		["WeaponDamageArcaneExact"] = "^%+?([%d%. ,]+) points de dégâts %(Arcanes%)$",
		["WeaponDamageEnchantment"] = "^%+?([%d%. ,]+) aux dégâts de l'arme$",
		["WeaponDamageEquip"] = "^Équipé : %+?([%d%. ,]+) aux dégâts de l'arme%.$",
		["WeaponDamageExact"] = "^([%d%. ,]+)Dégâts$",
		["WeaponDamageFire"] = "^%+?([%d%. ,]+) %- ([%d%. ,]+) points de Dégâts %(Feu%)$",
		["WeaponDamageFireExact"] = "^%+?([%d%. ,]+) points de dégâts %(Feu%)$",
		["WeaponDamageFrost"] = "^%+?([%d%. ,]+) %- ([%d%. ,]+) points de dégâts %(Givre%)$",
		["WeaponDamageFrostExact"] = "^%+?([%d%. ,]+) points de dégâts %(Givre%)$",
		["WeaponDamageHoly"] = "^%+?([%d%. ,]+) %- ([%d%. ,]+) points de dégâts %(Sacré%)$",
		["WeaponDamageHolyExact"] = "^%+?([%d%. ,]+) points de dégâts %(Sacré%)$",
		["WeaponDamageNature"] = "^%+?([%d%. ,]+) %- ([%d%. ,]+) points de dégâts %(Nature%)$",
		["WeaponDamageNatureExact"] = "^%+?([%d%. ,]+) points de dégâts %(Nature%)$",
		["WeaponDamageShadow"] = "^%+?([%d%. ,]+) %- ([%d%. ,]+) points de dégâts %(Ombre%)$",
		["WeaponDamageShadowExact"] = "^%+?([%d%. ,]+) points de dégâts %(Ombre%)$"
	},
	["UI"] = {
