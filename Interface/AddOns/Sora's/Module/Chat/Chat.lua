...
local function SetChatFrame()
    for i = 1, NUM_CHAT_WINDOWS do
        ...
        local _, size = ChatFrame:GetFont()
        EditBox:SetFont(STANDARD_TEXT_FONT, (size >= 10 and size <= 18) and size or 11, "OUTLINE")
        EditBoxHeader:SetFont(STANDARD_TEXT_FONT, (size >= 10 and size <= 18) and size or 11, "OUTLINE")
