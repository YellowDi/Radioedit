...
if not TidyPlatesContThemeList then TidyPlatesContThemeList = {} end
...
local TemplateTheme = {}
local defaultArtPath = "Interface\\Addons\\TidyPlatesContinued\\Media"
...
-- References
-----------------------------------------------
TidyPlatesContInternal.ThemeTemplate = TemplateTheme
