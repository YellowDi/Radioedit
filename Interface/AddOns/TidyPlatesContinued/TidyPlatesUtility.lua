...
TidyPlatesContUtility.IsFriend = function(...) end
--TidyPlatesContUtility.IsHealer =
TidyPlatesContUtility.IsGuildmate = function(...) end
...
TidyPlatesContUtility.GetNumRaidMembers = RaidMemberCount
TidyPlatesContUtility.GetNumPartyMembers = PartyMemberCount
TidyPlatesContUtility.GetSpec = GetSpec
...
TidyPlatesContUtility.GetGroupInfo = GetGroupInfo
...
-- GameTooltipScanner
------------------------------------------
local ScannerName = "TidyPlatesContScanningTooltip"
...
TidyPlatesContUtility.GetUnitQuestInfo = GetUnitQuestInfo
...
TidyPlatesContUtility.GetFriendlyThreat = GetFriendlyThreat
...
local function CreateDropdownFrame(helpertable, reference, parent, menu, default, label, valueMethod)
	local drawer = CreateFrame("Frame", reference, parent, "TidyPlatesContDropdownDrawerTemplate" )
...
TidyPlatesContUtility.PanelHelpers = PanelHelpers
...
do
	...
	TidyPlatesContUtility.CallIn = CallIn
...
do
	...
	TidyPlatesContUtility.OpenInterfacePanel = OpenInterfacePanel
end
