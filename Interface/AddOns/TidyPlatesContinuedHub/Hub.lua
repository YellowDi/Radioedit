...
local function BuildHubPanel(panel)
	...
	panel.FilterScaleLock, F = CreateQuickCheckbutton(objectName.."FilterScaleLock", "覆盖当前目标的样式", AlignmentColumn, F, 16)
...
-- [[
	...
	panel.ColorHostileNPC = CreateQuickColorbox(objectName.."ColorHostileNPC", "敌方NPC", AlignmentColumn, panel.ColorNeutral , 16)
	panel.ColorHostilePlayer = CreateQuickColorbox(objectName.."ColorHostilePlayer", "敌方玩家", AlignmentColumn, panel.ColorHostileNPC , 16)
	...
	panel.TextColorHostileNPC = CreateQuickColorbox(objectName.."TextColorHostileNPC", "敌方NPC", AlignmentColumn, panel.TextColorNeutral , OffsetColumnB + 16)
	panel.TextColorHostilePlayer = CreateQuickColorbox(objectName.."TextColorHostilePlayer", "敌方玩家", AlignmentColumn, panel.TextColorHostileNPC , OffsetColumnB + 16)
	...
	panel.ColorTapped, L = CreateQuickColorbox(objectName.."ColorTapped", "被其他玩家接触", AlignmentColumn, panel.OtherColorLabel , 16)
...
--]]
	...
	panel.ColorPartyAggro = CreateQuickColorbox(objectName.."ColorPartyAggro", "小队成员吸引仇恨", AlignmentColumn, panel.ColorShowPartyAggro , 14+OffsetColumnB)
	...
	panel.NameplateMaxDistance, F = CreateQuickSlider(objectName.."NameplateMaxDistance", "姓名板显示距离 (默认: 60)", "ACTUAL", nil, AlignmentColumn, F, 0, 4)
	...
	SetSliderMechanics(panel.NameplateMaxDistance, 60, 10, 100, 1)
