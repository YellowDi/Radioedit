...
TidyPlatesContHubDefaults.EnemyHeadlineColor = "ByReaction"
...
-- Add References
------------------------------------------------------------------------------
TidyPlatesContHubFunctions.SetHealthbarColor = HealthColorDelegate
TidyPlatesContHubFunctions.SetCastbarColor = CastBarDelegate
TidyPlatesContHubFunctions.SetThreatColor = ThreatColorDelegate
TidyPlatesContHubFunctions.SetNameColor = SetNameColorDelegate
