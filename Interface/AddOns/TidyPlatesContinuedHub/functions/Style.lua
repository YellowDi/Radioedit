...
TidyPlatesContHubDefaults.StyleEnemyMode = "ALLBARS"			-- Sets the default function
TidyPlatesContHubDefaults.StyleFriendlyMode = "BARSPLAYERS"			-- Sets the default function

AddHubFunction(StyleModeFunctions, TidyPlatesContHubMenus.StyleModes, StyleBarAlways, "Default Bars", "ALLBARS")
AddHubFunction(StyleModeFunctions, TidyPlatesContHubMenus.StyleModes, StyleHeadlineAlways, "Headline Always (No Health Bar)", "ALLHEADLINE")
AddHubFunction(StyleModeFunctions, TidyPlatesContHubMenus.StyleModes, StyleBarsInCombat, "Out-of-Combat - Health Bars during Combat", "BARSCOMBAT")
AddHubFunction(StyleModeFunctions, TidyPlatesContHubMenus.StyleModes, StyleBarsOnActive, "On Idle units - Health Bars on Active/Damaged/Marked Units", "BARSACTIVE")
AddHubFunction(StyleModeFunctions, TidyPlatesContHubMenus.StyleModes, StyleBarsOnPlayers, "On NPCs - Health Bars on Players", "BARSPLAYERS")
AddHubFunction(StyleModeFunctions, TidyPlatesContHubMenus.StyleModes, StyleBarsOnTarget, "On Non-Targets - Health Bar on Current Target", "BARSTARGET")
AddHubFunction(StyleModeFunctions, TidyPlatesContHubMenus.StyleModes, StyleBarsOnLowThreat, "On Aggroed units - Health Bars on Low Threat (Tank Mode)", "BARSLOWTHREAT")
--]]
...
-- Add References
------------------------------------------------------------------------------
TidyPlatesContHubFunctions.SetMultistyle = StyleIndexDelegate
TidyPlatesContHubFunctions.SetStyleBinary = StyleNameDelegate
TidyPlatesContHubFunctions.SetStyleNamed = StyleNameDelegate
--TidyPlatesContHubFunctions.SetStyleTrinary = SetStyleTrinaryDelegate
