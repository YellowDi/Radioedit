...
local function UpdateWidgetFrame(frame)
	...
	if points and points > 0 then
		...
		if pattern == nil then
			print("[Tidy Plates Continued][ERROR] invalid pattern for " .. PlayerClass .. " - " .. playerSpec) -- should not happen
			frame:_Hide()
			return
		end
...
TidyPlatesContWidgets.CreateComboPointWidget = CreateWidgetFrame
