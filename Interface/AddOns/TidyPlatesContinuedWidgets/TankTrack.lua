...
TidyPlatesContWidgets.IsEnemyTanked = IsEnemyTanked
TidyPlatesContWidgets.IsPlayerTank = IsPlayerTank


--[[
local function Dummy() end
TidyPlatesContWidgets.EnableTankWatch = Dummy
TidyPlatesContWidgets.DisableTankWatch = Dummy
--]]
