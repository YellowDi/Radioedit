...
-- Totem Icon Widget
--------------------
local classWidgetPath = "Interface\\Addons\\TidyPlatesContinuedWidgets\\ClassWidget\\"
...
TidyPlatesContWidgets.CreateTotemIconWidget = CreateTotemIconWidget
TidyPlatesContUtility.IsTotem = IsTotem
TidyPlatesContUtility.TotemSlot = TotemSlot
