...
-- Widget
local art = "Interface\\Addons\\TidyPlatesContinuedWidgets\\RangeWidget\\RangeWidget"
...
TidyPlatesContWidgets.CreateRangeWidget = CreateRangeWidget
