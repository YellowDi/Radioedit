...
-- Style Definition
---------------------------------------------
local ArtworkPath = "Interface\\Addons\\TidyPlatesContinued_Neon\\"
--local font = "Interface\\Addons\\TidyPlatesContinuedHub\\shared\\AccidentalPresidency.ttf"; local fontsize = 12;
...
--   /run print(TidyPlatesCont.ActiveThemeTable["Default"].frame.y)
---------------------------------------------
-- Default Style
---------------------------------------------
local Theme = {}
...
StyleDefault.target = {
	texture = "Interface\\Addons\\TidyPlatesContinued_Neon\\Neon_Select",
	width = 128,
	_width = 128,
	height = 32,
	x = 0,
...
--[[
StyleTextOnly.threatborder.texture = "Interface\\Addons\\TidyPlatesContinuedHub\\shared\\Aggro"
