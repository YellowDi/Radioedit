...
local path = "Interface\\Addons\\TidyPlatesContinued_Renaitre\\Textures\\"
--local font = "Interface\\Addons\\TidyPlatesContinued_Renaitre\\Fonts\\RobotoCondensed-Bold.ttf"; local fontsize = 10;
...
local arenaIconPath = "Interface\\AddOns\\TidyPlatesContinuedWidgets\\ArenaIcons"
...
local function ArenaIconCustom(unit)
	...
	return "Interface\\AddOns\\TidyPlatesContinuedWidgets\\ArenaIcons\\arena5"
...
WidgetConfig.DebuffWidget = { anchor = "TOP" , x = 15 ,y = VerticalAdjustment + 36 }
WidgetConfig.AbsorbWidget =	{ anchor="LEFT", x = 1, y = VerticalAdjustment + 17, w = 98, h = 26 }
