...
local path = "Interface\\Addons\\TidyPlatesContinued_Roth\\Media\\"
local fontroboto = "Interface\\Addons\\TidyPlatesContinuedHub\\shared\\RobotoCondensed-Bold.ttf"
...
---------------------------------------------
-- Tidy Plates Continued Hub Integration
---------------------------------------------
