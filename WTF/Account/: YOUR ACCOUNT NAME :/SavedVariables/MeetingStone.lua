...
MEETINGSTONE_UI_DB = {
	...
	["global"] = {
		["serverDatas"] = {
			["ActivitiesData"] = {
				["data"] = "$1$Z$S130`你搞活动我买单`挑战者的宝箱`8月19日（周六）20点，挑战者的宝箱*J冒险的伙伴共同进退，无论钥石的等级忽上忽下；宝箱的奖励力争最好，无论挑战的词缀千变万化。史诗的旅程，活动主持人：斗鱼TV-孤单的木头（房间号：70994）在集合石等你一起出发。*J集合石活动QQ报名群：108885849*J集合石活动专题页面：{URL}`http://w.163.com/special/convene-stone/`1`3$$",
			},
			["MallData"] = {
