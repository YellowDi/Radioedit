...
WeakAurasSaved = {
	...
	["displays"] = {
		...
		["CC Tracker "] = {
			...
			["borderBackdrop"] = "Blizzard Tooltip",
			["disjunctive"] = "all",
			["xOffset"] = -27.4215087890625,
			["border"] = false,
			["borderEdge"] = "None",
			["anchorPoint"] = "CENTER",
			["borderSize"] = 16,
			["yOffset"] = -271.387084960938,
			["borderColor"] = {
				1, -- [1]
				1, -- [2]
				1, -- [3]
	...
	["frame"] = {
		["xOffset"] = -655.070922851563,
		["yOffset"] = -267.430847167969,
		["height"] = 492,
